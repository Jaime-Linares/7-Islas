...
export default function RankingGamesWon() {
    const user = tokenService.getUser();
    const [message, setMessage] = useState(null);
    const [visible, setVisible] = useState(false);
    const atributte = "gamesWon";
    ...
    return (
        <div className="player-ranks-background">
            <div className="player-ranks-main">
                <h1>Ranking - Games Won</h1>
                {modal}
                <Button
                    size="lg"
                    color="danger"
                    onClick={() => {
                        window.location.href = '/ranking/averageScore';
                    }}
                >
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th style={{ fontSize: 25, width: "25%" }}>Games Won</th>
                        </tr>
                    </thead>
